...
if ($site_logo) {
  ...
  echo '<div class="site-logo text-center"><img src="'.base_url('files/pathfinder/images').'/dispusibda.png" class="img-responsive" /></div>';  
}
?>
...
if ($logged_in && $group == 'Librarian') {
  ...
  echo '<div style="display: flex; justify-content: space-between; padding: 15px">';
  echo create_button('anchor', site_url('pathfinder/add'), 'add-pathfinder', 'Add New Pathfinder', 'btn-success', '', $icon = 'plus-sign');
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
    <li><a href="',site_url('export/word'),'">Word</a></li>
    <li><a href="',site_url('export/pdf'),'">PDF</a></li>
  </ul>
</div>';
  echo '</div>';
  echo '</div>';
